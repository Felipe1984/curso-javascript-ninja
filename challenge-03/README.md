...
*/
pessoa.nomeCompleto(); // Olá! Meu nome é Felipe Anjos!
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // Olá, eu sou o Felipe Anjos, tenho 23 anos, 1.73, meu peso é 82 e, só hoje, eu já caminhei 450 metros!
```
