...
carro.adicionarPessoa = function(quantidade) {
  ...
  var pessoas = vagas === 1 ? ' pessoa' : ' pessoas';
  
  if(carro.quantidadePessoas === 5 && quantidade > 0){
    return 'O carro já está lotado!';
  }
  
  if(totalPessoas > 5) {
    return vagas === 1 ? 'Só cabe mais ' + vagas + ' pessoa!' : 'Só cabem mais ' + vagas + ' pessoas!';
  }
...
carro.quantidadePessoas -= 4; /** ou **/ carro.adicionarPessoa(-4); // 1 
